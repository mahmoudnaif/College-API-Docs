...
const App = () => {
  ...
  return (
    ...
    <Routes >
    <Route path="/College-API-Docs" element={<HomePage darkmode={darkmode}/>} />
    <Route path="/College-API-Docs/Docs" element={<Docs setOpenSideBar={setOpenSideBar} openSideBar={openSideBar}  darkmode={darkmode} />} />
